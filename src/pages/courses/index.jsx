              ...
              <div className="flex allCourses__page-sidebar--findBox ">
                ...
                <div className="flex w-full bg-gray-100 bg-opacity-50 border border-gray-300 allCourses__page-sidebar--findBox--find item-center h-14 ">
                  ...
                  <input
                    ...
                    id="email"
                    name="search"
                    className="w-full px-3 py-1 text-base text-lg leading-8 text-gray-700 transition-colors duration-200 ease-in-out outline-none font-1 focus:border-royal-blue focus:bg-transparent focus:ring-2 focus:ring-indigo-200"
                  />
                </div>
              </div>
