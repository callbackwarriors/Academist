...
const TestimonialCart = ({fd}:any) => {
 console.log(fd.image)
    ...
    return (
        ...
        //     <Image className="rounded-full" width="50px" height="50px" src={fd.image}></Image>            
...
<section className="text-gray-600 body-font">
  <div className=" px-5 py-24 mx-auto">
    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-3 md:w-11/12 w-full">
        <div className="h-full bg-gray-100 p-8 rounded">
          ...
          <a className="inline-flex items-center">
            ...
            <span className="flex-grow flex flex-col pl-4">
              <span className="title-font font-medium text-gray-900">{fd.name}</span>
              <span className="text-gray-500 text-sm">{fd.position}</span>
            </span>
          </a>
        </div>
      </div>
