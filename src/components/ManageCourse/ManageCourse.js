  ...
  return (
    <div className="single__course">
      ...
      <div className="flex-auto" >
        ...
        <button className="px-4 py-2 text-white bg-indigo-600 border-0 rounded cursor-pointer focus:outline-none hover:bg-aquamarine-800"><RiDeleteBin7Line onClick={() => deleteHandler(_id)} className="text-2xl" /></button>
      </div>
    </div>
  );
};
